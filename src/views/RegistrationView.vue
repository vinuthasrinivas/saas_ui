<template>
  <div id="registrationPage" class="h-full w-full">
    <div id="loginBox">
      <div id="clientLogo">
      ...
      <div id="registrationDetails">
        <form @submit.prevent="registerUser()" class="main__form">
          <div class="group">
            <input
              id="name"
              class="inputfield"
          ...
          <div class="submitButtonSection">
            <button id="submit" class="button bg-primaryBlue">Sign up</button>
          </div>
...
export default {
  setup() {
    ...
    const password = ref("");
    const userName = ref("");
    document.title = "Sign up - RobusTest";
